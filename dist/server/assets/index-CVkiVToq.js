...
function Balloons({ count = 14 }) {
  const balloons = reactExports.useMemo(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-0 overflow-hidden", children: balloons.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-screen w-full overflow-hidden bg-gradient-hero grain-overlay", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 right-0 h-8 film-tape z-20 opacity-90" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 h-8 film-tape z-20 opacity-90" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 light-leak" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Balloons, { count: 16 }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex h-full flex-col items-center justify-center px-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-script text-2xl md:text-3xl text-soft-gold mb-4", children: "The batch we’ll never forget…" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-black text-6xl md:text-9xl tracking-tight text-beige drop-shadow-[0_4px_30px_rgba(0,0,0,0.8)]", children: [
              "Byeeee Seniors ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.p,
        {
          ...
          children: "We'll miss you forever."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.p,
        {
          ...
          children: "BE IT · The Final Goodbye"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-script text-soft-gold text-xl", children: "Scroll to relive memories ↓" })
      }
    )
  ] });
}
...
function PhotoCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "group relative mx-4 w-[260px] flex-shrink-0 md:w-[340px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-2xl border-4 border-[#E8DCCB] bg-[#E8DCCB] p-2 shadow-2xl transition-all duration-500 group-hover:scale-105", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-tr from-yellow-200/20 via-transparent to-orange-300/20 mix-blend-screen" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 px-2 pb-2 text-center text-xl italic text-[#3b2a20]", children: caption })
  ] }) });
}
function Gallery() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-gradient-to-b from-[#1a120f] via-[#241815] to-[#120d0b] py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl italic text-yellow-200 md:text-4xl", children: "Chapter One" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 text-5xl italic text-[#E8DCCB] md:text-7xl", children: "A roll of memories" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-6 max-w-2xl text-[#E8DCCB]/70", children: "Every frame, every smile, every late night — will always be in our hearts." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mb-12 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        animate: { x: ["0%", "-50%"] },
        transition: {
        ...
        children: [...ROW_A, ...ROW_A].map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(PhotoCard, { ...p }, `a-${i}`))
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        className: "flex w-max",
        children: [...ROW_B, ...ROW_B].map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(PhotoCard, { ...p }, `b-${i}`))
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-y-0 left-0 z-20 w-32 bg-gradient-to-r from-[#120d0b] to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-y-0 right-0 z-20 w-32 bg-gradient-to-l from-[#120d0b] to-transparent" })
  ] });
}
...
const REELS = [
  {
    id: 1,
    video: "https://drive.google.com/file/d/13dfxe7WuA2plK6lrMFwlBaOA9Hy1JxWz/preview",
    title: "Memories",
    caption: "The memories which will last forever."
  },
  {
    id: 2,
    video: "https://drive.google.com/file/d/1f2ltJqetJ0AlX5Kw0aOYWIrDzK4SB6Ag/preview",
    title: "Fun Times",
    caption: "Noise, laughter, chaos… us."
  },
  {
    id: 3,
    video: "https://drive.google.com/file/d/1yf_yuRo1bl5GLeDshkXaqajc_g25ZxW3/preview",
    title: "The Goodbyes",
...
function Reels() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-black py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-yellow-200/10 blur-3xl" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-0 opacity-[0.04] mix-blend-soft-light", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full w-full bg-[radial-gradient(circle,_rgba(255,255,255,0.15)_1px,_transparent_1px)] bg-[size:18px_18px]" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 30 },
        ...
        className: "relative z-10 mb-16 px-6 text-center",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl italic tracking-wide text-yellow-200", children: "Chapter Two" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 text-5xl italic text-[#E8DCCB] md:text-7xl", children: "Moving Memories" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-4 max-w-xl text-[#E8DCCB]/70", children: "Some moments were too alive to stay still." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto grid max-w-6xl grid-cols-1 gap-10 px-6 md:grid-cols-3", children: REELS.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.button,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-20 w-20 items-center justify-center rounded-full bg-black/50 backdrop-blur-md transition-transform duration-300 group-hover:scale-110", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "h-10 w-10 fill-yellow-200 text-yellow-200" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-5 text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl text-[#E8DCCB]", children: r.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 italic text-yellow-200", children: r.caption })
          ] })
        ]
      },
      r.id
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: activeReel && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
...
function ThankYou() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen overflow-hidden bg-gradient-hero py-32 grain-overlay", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Balloons, { count: 20 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 light-leak opacity-80" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto max-w-3xl px-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.h2,
        {
          ...
          children: [
            "Thank You Seniors",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-vintage-red mt-4", style: { textShadow: "0 0 40px var(--vintage-red)" }, children: "❤️" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No matter where life takes you…" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "We are always proud of you guys." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-soft-gold", children: "Thank you for the memories, guidance, laughter, and chaos." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display italic", children: "You'll always be a part of us." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "mt-24",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto h-px w-32 bg-soft-gold/50" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 font-script text-2xl text-soft-gold", children: "With love," }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg text-beige tracking-[0.3em] uppercase mt-2", children: "from your juniors" })
          ]
        }
      )
    ] })
...
const backgroundMusic = "/assets/Woh%20Din%20Chhichhore%20128%20Kbps-Doh8l4dN.mp3";
function MusicToggle() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      children: playing ? /* @__PURE__ */ jsxRuntimeExports.jsx(Music, { className: "h-5 w-5 animate-pulse" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeX, { className: "h-5 w-5" })
    }
  );
}
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ThankYou, {}),
